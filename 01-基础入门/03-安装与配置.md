...
# 根据 CPU 架构选择对应的版本
# Intel Mac (amd64)
wget https://github.com/grafana/k6/releases/latest/download/k6-v0.47.0-macos-amd64.tar.gz

# Apple Silicon (arm64)
wget https://github.com/grafana/k6/releases/latest/download/k6-v0.47.0-macos-arm64.tar.gz

# 解压（替换为实际下载的文件名）
tar -xzf k6-v0.47.0-macos-*.tar.gz

# 移动到 PATH
sudo mv k6-v0.47.0-macos-*/k6 /usr/local/bin/
...
```bash
# 下载对应架构的二进制文件（amd64/arm64）
# 访问 https://github.com/grafana/k6/releases/latest 查看最新版本
wget https://github.com/grafana/k6/releases/latest/download/k6-v0.47.0-linux-amd64.tar.gz
...
1. 下载 ZIP 文件（访问最新版本）：
   ```
   https://github.com/grafana/k6/releases/latest/download/k6-v0.47.0-windows-amd64.zip
   ```
